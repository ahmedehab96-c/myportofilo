...
export const featuredProjects = [
  {
    ...
    readme: `HRM NAWA TECH is a full-stack multi-tenant HR platform built with Laravel Filament (admin), a React SPA dashboard, and Flutter (employee app).
...
Source is private — email your GitHub username for collaborator access.`,
    ...
    tech: ['Flutter', 'Laravel', 'Filament', 'React', 'Sanctum', 'REST API', 'go_router', 'Docker', 'GitHub Actions'],
    keywords: [
      'hrm', 'hrm nawa tech', 'nawa tech hr', 'react', 'react dashboard', 'react spa', 'saas',
      'multi-tenant', 'trial', 'subscription', 'human resources', 'hr system', 'payroll',
      'attendance', 'employees', 'leave request', 'laravel', 'filament', 'platform console',
      'ai command center', 'recruitment', 'live demo', 'render', 'rbac', 'responsive',
    ],
...
**Source:** private — email your GitHub username for access.`,
  },
  {
    ...
    readme: `Life OS is a completely free Flutter app for organizing life: tasks, expenses, goals, habits, notes, and an AI assistant.
...
The dashboard combines daily task planning, habit tracking, finance charts, goal progress, and smart reminders. Data is stored locally with SQLite for offline use and synced to Supabase when online. The built-in AI assistant uses an open-source Llama model via Groq, supports speech-to-text input, and can execute real commands on your data.`,
    ...
    screenshots: ['/assets/images/lifeos_mockup.png'],
    ...
    keywords: [
      'lifeos', 'life os', 'productivity', 'habits', 'goals', 'reminders', 'daily planner',
      'lifestyle app', 'supabase', 'bloc', 'sqlite', 'groq', 'ai assistant', 'responsive',
    ],
    categories: ['Mobile', 'AI'],
    githubUrl: 'https://github.com/ahmedehab96-c/LifeOS',
    isGithubPrivate: false,
    playStoreUrl: 'https://play.google.com/store/apps/details?id=com.ahmed.lifeos',
...
Run web locally: clone [LifeOS](https://github.com/ahmedehab96-c/LifeOS), then \`flutter pub get\` and \`flutter run -d chrome\`.`,
  },
  {
    ...
    readme: `Mezo Food App (from project README) - food ordering and delivery with a customer mobile app and a responsive admin web dashboard.
...
• Android APK: https://ahmedmyportofilo.netlify.app/apks/mezo.apk`,
    ...
    screenshots: ['/assets/images/mezo_screens.png'],
    ...
    tech: ['Flutter', 'BLoC', 'Firebase', 'Stripe', 'Google Maps', 'Cloud Functions'],
    keywords: [
      'mezo', 'mezo food', 'food delivery', 'food app', 'restaurant', 'order food', 'menu',
      'cart', 'checkout', 'firebase', 'stripe', 'admin dashboard', 'google maps', 'live demo',
      'apk', 'responsive', 'rtl',
    ],
...
\`flutter run -d chrome -t lib/admin/main_admin.dart\` or \`bash scripts/run_admin_web.sh\``,
  },
  {
    ...
    readme: `IT Assist - Nawa Tech (from project README): Smart IT Support SaaS - Flutter Mobile App + Laravel Web Panel + REST API.
...
**Android APK:** https://ahmedmyportofilo.netlify.app/apks/itassist.apk`,
    ...
    keywords: [
      'it assist', 'it assist nawa tech', 'nawa tech it', 'helpdesk', 'it support', 'ticketing',
      'asset management', 'it system', 'itsm', 'socket.io', 'laravel', 'firebase', 'live demo',
      'render', 'apk', 'responsive', 'sla',
    ],
    categories: ['SaaS', 'Mobile', 'Web', 'Backend', 'AI'],
...
3. Panel: http://127.0.0.1:8000/panel/login`,
  },
  {
    ...
    readme: `Werdi v1.0.1 is a Quran memorization and revision app. The latest release removes the login gate — open the app and start immediately. Progress is stored locally on the device, with optional Supabase sync.
...
Built with Clean Architecture, BLoC, go_router, Drift, just_audio, and Supabase. Material 3 themes and responsive layout for phones and tablets.`,
    ...
    tech: ['Flutter', 'BLoC', 'go_router', 'Drift', 'Supabase', 'just_audio', 'flutter_screenutil'],
    keywords: [
      'werdi', 'quran app', 'memorization', 'tasmee3', 'quran revision', 'islamic app',
      'recitation', 'no login', 'ayah audio', 'achievements', 'responsive',
    ],
    categories: ['Mobile'],
    githubUrl: 'https://github.com/ahmedehab96-c/werdi',
    isGithubPrivate: false,
    playStoreUrl: 'https://play.google.com/store/apps/details?id=com.werdi.app',
    webSetupGuide: `Free on Google Play — install and start instantly.
No login required, start memorizing immediately.`,
  },
  {
    ...
    readme: `BankX Digital Banking is a Flutter mobile banking experience with splash, sign-in, home dashboard, transfers, and bill payment flows.
...
• Download the Android APK from this portfolio`,
    ...
    screenshots: ['/assets/images/bankx_mockup.png'],
    ...
    keywords: [
      'bankx', 'banking', 'digital banking', 'fintech', 'mobile banking', 'transfer',
      'bill payment', 'flutter', 'finance app',
    ],
    categories: ['Mobile'],
    githubUrl: undefined,
    isGithubPrivate: true,
...
2. Install on your phone and explore dashboard, transfer, and bill pay flows`,
  },
  {
    ...
    readme: `StepZone is a premium Flutter eCommerce app for luxury footwear. It connects to a live Supabase backend for products, cart, wishlist, orders, reviews, and coupons.
...
• React.js + Vite web storefront with Tap Payments (cards, Tabby, Tamara)`,
    ...
    screenshots: ['/assets/images/stepzone_mockup_v2.png'],
    ...
    tech: [
      'Flutter', 'GetX', 'Supabase', 'PostgreSQL', 'Edge Functions', 'Google OAuth',
      'Clean Architecture', 'Material 3', 'React.js', 'Vite', 'Tap Payments',
    ],
    keywords: [
      'stepzone', 'shoes', 'ecommerce', 'luxury', 'supabase', 'flutter', 'cart', 'checkout',
      'coupons', 'google sign in', 'aed', 'react', 'react.js', 'vite', 'web storefront',
    ],
    categories: ['Mobile', 'Web', 'Backend'],
...
Source is public.`,
    ...
    screenshots: [
      '/assets/images/propertymgmt_screens.png',
      '/assets/images/propertymgmt_welcome.png',
      '/assets/images/propertymgmt_home.png',
    ],
...
export function assistantDetail(project) {
  const featureLines = project.features.map((f) => `• ${f}`).join('\n');
